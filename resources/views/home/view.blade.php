        ...
        <div class="container">				
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <p class="text-white link-nav"><a href="index.html">Home </a> <span class="lnr lnr-arrow-right"></span> <a href="/home"> View Law firm </a></p>
                </div>	
            </div>
        </div>
    </section>  
    ...
    <div class="container" >
        ...
        <div class="card mb-4">
            <div class="card-body">
               ...
               <p>{!!$firm->street_address . "<br/>". $firm->city.",".$firm->country!!}</p>
            ...
            <div class="row">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="single-post row">
                                                        ...
                                                        <div class="col-lg-8 col-md-8">
                                                            ...
                                                            <h3 class="mt-20 mb-20">People</h3>
                                                            <p class="excert">
                                                              Doreen Mwesigye
                                                            </p>
                                                            <h3 class="mt-20 mb-20">Websites</h3>
                                                            <p class="excert">
                                                             <i> {{$firm->website}} </i>
                                                            </p>
                    ...
                    <div class="col-lg-4">
                            ...
                            <h4>Contact <span style="color:red">{{$firm->name}}</span></h4>
                                    <form method="POST" action="/firm/sendmail">
                                        @csrf
                                        <input type="hidden" name="firm_email" value="{{$firm->email}}">
                                        ...
                                        <button type="submit" class="primary-btn text-uppercase">Send Message</button>
                                    </form>
                                </div>

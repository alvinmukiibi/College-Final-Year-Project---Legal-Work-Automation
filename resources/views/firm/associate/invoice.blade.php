                        ...
                        <main>
                            <div class="row contacts">
                                ...
                                <div class="col invoice-details">
                                    <h1 class="invoice-id">INVOICE {{ __('#') }}  {{ $invoice->invoice_no }}</h1>
                                    ...
                                    <div class="date">Invoice Generated By : {{ $invoice->fname }} {{ $invoice->lname }}</div>
                                </div>
                            </div>
                            ...
                            <div class="notices">
                                <div>NOTICE:</div>
                                <div class="notice">Please present this invoice, especially the invoice #, at the time of payment</div>
                            </div>

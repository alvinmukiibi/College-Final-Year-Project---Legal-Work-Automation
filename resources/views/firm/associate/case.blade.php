                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="callout callout-info">
                                <h5><i class="fa fa-info"></i> CASE STATUS: INTAKE</h5>
                                {{ __('This case is still an intake. Use the Buttons on the right to either accept or reject it') }}
                                <button type="submit" class="btn btn-success btn-sm pull-right"> <b>MAKE CASE</b> </button>
                                <button type="submit" class="btn btn-danger btn-sm pull-right"> <b>REJECT CASE</b> </button>
                            </div>
                        </div>
